...
'
  'motion_optimisation' 'export UAV_NAME="uav1"; export NEIGH_NAME_1="uav2"; NEIGH_NAME_2="uav3";waitForRos; roslaunch --wait motion_optimiser_v2 motion_optimiser_v2.launch 
'
)
