...
input=(
  'Rosbag' 'export UAV_NAME="uav$NUMBER1"; waitForOffboard; ./record.sh
'
  'NodeChecker' 'export UAV_NAME="uav$NUMBER1"; waitForRos; roslaunch mrs_uav_general node_crash_checker.launch
'
...
'
  'odom_diag' 'export UAV_NAME="uav$NUMBER1"; waitForRos; rostopic echo /"uav$NUMBER1"/odometry/diagnostics
'
  'mavros_diag' 'export UAV_NAME="uav$NUMBER1"; waitForRos; rostopic echo /"uav$NUMBER1"/mavros_interface/diagnostics
'
  'kernel_log' 'tail -f /var/log/kern.log -n 100
'
  'roscore' 'roscore
'
  'perception' 'export UAV_NAME="uav$NUMBER1"; waitForRos; waitForOdometry; roslaunch blob_det_v2 blob_det_v2_real.launch 
'
  'sensor_fusion' 'export UAV_NAME="uav$NUMBER1"; export NEIGH_NAME_1="uav$NUMBER2";export NEIGH_NAME_2="uav$NUMBER3"; waitForRos; waitForOdometry; roslaunch sensor_fusion_v2 sensor_fusion_v2.launch 
' 
  'motion_optimisation' 'export UAV_NAME="uav$NUMBER1"; export NEIGH_NAME_1="uav$NUMBER2";export NEIGH_NAME_2="uav$NUMBER3"; waitForRos; waitForOdometry; roslaunch motion_optimiser_v2 motion_optimiser_v2.launch 
'
  'commander' 'export UAV_NAME="uav$NUMBER1"; export UAV_NAME_1="uav$NUMBER1"; export UAV_NAME_2="uav$NUMBER2"; export UAV_NAME_3="uav$NUMBER3"; waitForRos; roslaunch  mode_commander mode_commander.launch
'
)
