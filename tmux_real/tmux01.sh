...
'
  ...
  'sensor_fusion' 'export UAV_NAME="uav${UAV_NUMBERS[0]}"; export NEIGH_NAME_1="uav${UAV_NUMBERS[1]}";export NEIGH_NAME_2="uav${UAV_NUMBERS[2]}"; export OFFSET_ANGLE=0.0 ;waitForRos; roslaunch --wait sensor_fusion_v2 sensor_fusion_v2.launch 
' 
  'motion_optimisation' 'export UAV_NAME="uav${UAV_NUMBERS[0]}"; export NEIGH_NAME_1="uav${UAV_NUMBERS[1]}";export NEIGH_NAME_2="uav${UAV_NUMBERS[2]}"; export OFFSET_ANGLE=0.0 ;waitForRos; roslaunch --wait motion_optimiser_v2 motion_optimiser_v2.launch 
'
)
