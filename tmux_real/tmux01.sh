...
'
  'roscore' 'roscore
'
  'perception' 'export UAV_NAME="uav$NUMBER1"; waitForRos; roslaunch --wait blob_det_v2 blob_det_v2_real.launch 
'

  'sensor_fusion' 'export UAV_NAME="uav$NUMBER1"; export NEIGH_NAME_1="uav$NUMBER2";export NEIGH_NAME_2="uav$NUMBER3"; export OFFSET_ANGLE=0.0 ;waitForRos; roslaunch --wait sensor_fusion_v2 sensor_fusion_v2.launch 
' 
  'motion_optimisation' 'export UAV_NAME="uav$NUMBER1"; export NEIGH_NAME_1="uav$NUMBER2";export NEIGH_NAME_2="uav$NUMBER3"; export OFFSET_ANGLE=0.0 ;waitForRos; roslaunch --wait motion_optimiser_v2 motion_optimiser_v2.launch 
'
)
