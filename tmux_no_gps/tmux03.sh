...
# '
  'roscore' 'roscore
' 
  'perception' 'export UAV_NAME="uav$NUMBER1"; waitForRos; roslaunch blob_det_v2 blob_det_v2_real.launch 
'
  'sensor_fusion' 'export UAV_NAME="uav$NUMBER1"; export NEIGH_NAME_1="uav$NUMBER2";export NEIGH_NAME_2="uav$NUMBER3"; waitForRos; roslaunch sensor_fusion_v2 sensor_fusion_no_gps.launch 
' 
  'motion_optimisation' 'export UAV_NAME="uav$NUMBER1"; export NEIGH_NAME_1="uav$NUMBER2";export NEIGH_NAME_2="uav$NUMBER3"; waitForRos; roslaunch motion_optimiser_v2 motion_optimiser_no_gps.launch 
'
)
