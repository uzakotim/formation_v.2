...
# '
  'roscore' 'roscore
'
  'fake_odom' 'export UAV_NAME_1="uav$NUMBER1"; export UAV_NAME_2="uav$NUMBER2"; export UAV_NAME_3="uav$NUMBER3"; waitForRos; roslaunch  fake_odometry fake_odometry.launch
'
